            ...
            <div id="quick-search-more" class="row gutter-5">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="english_meaning" class="form-control" name="english_meaning"
                                               placeholder="معنی لاتین را وراد کنید" value="{{ $word->english_meaning }}" style="direction: ltr">
